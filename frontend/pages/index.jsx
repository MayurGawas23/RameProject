                ...
                <div className="lg:w-[72%] w-full p-2">
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-evenly gap-4">
                        ...
                        <div className="w-full sm:w-[48%] lg:w-[30%] p-4 bg-white rounded-sm shadow-sm"                            >
                            ...
                            <Link href='conferences' className="text-blue-700 text-lg hover:underline cursor-pointer flex items-center gap-1">
                        ...
                        <div className="w-full sm:w-[48%] lg:w-[30%] p-4 bg-white rounded-sm shadow-sm"                            >
                            ...
                            <Link href='books' className="text-blue-700 text-lg hover:underline cursor-pointer flex items-center gap-1">
